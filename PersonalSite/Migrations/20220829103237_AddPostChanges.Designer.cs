...
namespace PersonalSite.Migrations
{
    ...
    [Migration("20220829103237_AddPostChanges")]
    partial class AddPostChanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonalSite.Core.Models.Entities.FileObjectChangeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("FileObjectEntityId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("FileObjectEntityId");
            ...
            modelBuilder.Entity("PersonalSite.Core.Models.Entities.FileObjectChangeEntity", b =>
                {
                    b.HasOne("PersonalSite.Core.Models.Entities.FileObjectEntity", "FileObjectEntity")
                        .WithMany()
                        .HasForeignKey("FileObjectEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FileObjectEntity");
                });
